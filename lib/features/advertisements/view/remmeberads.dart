...
// class RemmemberAdvertisementPage extends StatelessWidget {
//   RemmemberAdvertisementPage({super.key});
...
//     advertisementController.remmeberAdvertisements();

//     return Directionality(
//       textDirection: TextDirection.rtl,
//       child: Scaffold(
//         appBar: CustomAppBar("تذكيرات", []),
//         body: Obx(
//           () => ListView.builder(
//             // itemCount: advertisementController.advertisements.length,
//             itemCount: advertisementController.remmeberadvertisements.length,
//             itemBuilder: (context, index) {
//               var advertisement = TrainingAdvertismentModel.fromJson(
//                   advertisementController.remmeberadvertisements[index]);
//               return Padding(
